...
public abstract class By {
  ...
  */
   ...
   * Find a single element. Override this method if necessary.
   *
   * @param xpathExpression A xpathExpression to use to find the element with webdriver wait.
   * @return The WebElement that matches the selector.
   */
    public static WebElement getElementByXpath (String xpathExpression, String seconds) {
